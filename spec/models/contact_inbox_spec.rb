  ...
  describe 'validations' do
    context 'when source_id' do
      ...
      it 'validates whatsapp channel source_id' do
        ...
        valid_bsuid_source_id = build(:contact_inbox, contact: contact, inbox: whatsapp_inbox, source_id: 'BR.982376234502700')
      ...
      it 'validates twilio whatsapp channel source_id' do
        ...
        valid_parent_bsuid_source_id = build(
          :contact_inbox, contact: contact, inbox: twilio_whatsapp_inbox, source_id: 'whatsapp:IN.ENT.9081726354'
        )
